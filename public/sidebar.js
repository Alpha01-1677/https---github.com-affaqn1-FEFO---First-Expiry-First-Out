...
export const NAV_PAGES = [
    ...
    {
        id: 'retailer_scorecard',
        label: 'Retailer Scorecard',
        href: 'retailer_scorecard.html',
        subtitle: 'Retailer Clearance Scorecard',
        icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>`
    },
    {
        id: 'financial_roi',
        label: 'Product Rescue',
        href: 'financial_roi.html',
        subtitle: 'Volume comparison of salvaged batches',
        icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 8l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2"/>`
    },
    {
        id: 'audit_logs',
        label: 'Audit Logs',
...
export function buildSidebar(activePage) {
    ...
    const isAuditor = user_role.toLowerCase().includes('auditor');

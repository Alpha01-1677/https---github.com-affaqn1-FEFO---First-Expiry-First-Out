...
- Name: sprint3.spec.js >> Sprint 3: Manual Test Cases (PB12 – PB15) >> TC-09 [Promotion Analytics]: Retailer can accept an offer and see success confirmation
- Location: tests\sprint3.spec.js:474:3

# Error details

```
Error: Login failed for retailer1@nestle.com: 
```

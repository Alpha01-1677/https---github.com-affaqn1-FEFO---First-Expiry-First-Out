...
- Name: sprint3.spec.js >> Sprint 3: Manual Test Cases (PB12 – PB15) >> TC-PB14-B [PB14]: Auto-filled discount matches one of the three velocity tiers (10/25/40)
- Location: tests\sprint3.spec.js:305:3

...
- Name: sprint2-dashboard.spec.js >> Sprint 2: Manual Test Cases - Dashboard & Features (PB5-PB8) >> Dashboard Data Accuracy (PB5)
- Location: tests\sprint2-dashboard.spec.js:23:5
...
- button:
  - img
- img
- text: "Authentication failed: Failed to get document because the client is offline."
- button "Sign In"
